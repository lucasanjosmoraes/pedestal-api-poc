...
(def routes #{["/hi" :get
               [inc-error/service-error-handler
                inc-http/coerce-body
                inc-http/content-negotiator
                handlers/respond-hi]
               :route-name :hi]
              ["/hello/:name" :get
               [inc-error/service-error-handler
              ...
              ["/todo" :post
               [inc-error/service-error-handler
                ...
                inc-http/content-negotiator
                inc-db/in-memory
                inc-domain/list-create]]
              ["/todo/:list-id" :get
               [inc-error/service-error-handler
                inc-http/coerce-body
                inc-http/content-negotiator
                inc-domain/entity-render
                inc-db/in-memory
                inc-domain/list-view]]
              ["/todo/:list-id" :post
               [inc-error/service-error-handler
                inc-http/coerce-body
                inc-http/content-negotiator
                inc-domain/entity-render
                inc-domain/list-item-view
                inc-db/in-memory
                inc-domain/list-item-create]]
              ...
              ["/todo/:list-id/:item-id" :put
               [inc-error/service-error-handler
                ...
                inc-domain/list-item-view
                inc-db/in-memory
                inc-domain/list-item-update]]
              ["/todo/:list-id/:item-id" :delete
               [inc-error/service-error-handler
                inc-http/coerce-body
                inc-http/content-negotiator
                inc-domain/entity-render
